          ...
          <div className="p-4 space-y-2.5">
            {order.keyValues?.map((key, keyIndex) => (
              <div key={keyIndex} className="flex items-center gap-2.5 bg-[#0d0f12] border border-[#10b981]/20 rounded-2xl p-3 group hover:border-[#10b981]/40 transition-colors">
                ...
                <motion.button type="button" whileTap={{ scale: 0.8 }} whileHover={{ scale: 1.1 }} onClick={() => copyKey(key)} className="flex-shrink-0 w-9 h-9 rounded-xl bg-[#10b981]/10 border border-[#10b981]/30 flex items-center justify-center text-[#10b981] hover:bg-[#10b981]/20 transition-all">
